...
if 'extremas' not in st.session_state:
    st.session_state.extremas = {} # Estructura: {'OACI': {'max': 20, 'h_max': '15:00', 'min': 5, 'h_min': '06:00'}}

# --- 2. FUNCIONES TÉCNICAS Y EXTRACCIÓN ---

def calcular_dif_angular(dir1, dir2):
    """Calcula la distancia mínima en la rosa de los vientos (360°)."""
    diff = abs(dir1 - dir2)
